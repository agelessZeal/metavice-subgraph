...
import { BIG_INT_ZERO, SUSHI_TOKEN_ADDRESS,METAVICE_TOKEN_ADDRESS } from 'const'
...
export function getMiniChef(block: ethereum.Block): MiniChef {
  ...
  if (miniChef === null) {
    ...
    miniChef.metavice = METAVICE_TOKEN_ADDRESS
    miniChef.metavicePerSecond = BIG_INT_ZERO
